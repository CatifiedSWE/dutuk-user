...
export default function Footer() {
    return (
        <footer className="w-full bg-[#1B0F11] pt-20 pb-10 px-4 md:px-8 lg:px-20 text-white relative overflow-hidden">
            {/* Decorative Background Elements */}
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#FFC13C] via-[#7C2A2A] to-[#FFC13C]" />
            <div className="absolute -top-[200px] -right-[200px] w-[500px] h-[500px] bg-[#7C2A2A]/20 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] bg-[#FFC13C]/5 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="max-w-[1440px] mx-auto flex flex-col gap-16 relative z-10">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-10 border-b border-white/10 pb-16">
                    <div className="flex flex-col gap-4 text-center lg:text-left max-w-xl">
                        ...
                        <p className="font-urbanist text-stone-300 text-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                        ...
                        <p className="font-urbanist text-stone-400 text-base leading-relaxed max-w-sm">
                    ...
                    <div className="lg:col-span-3 flex flex-col gap-6">
                        ...
                        <p className="font-urbanist text-stone-400 text-sm">
                            Manage your events on the go. Available for iOS and Android.
                        </p>
                        <div className="flex flex-col sm:flex-row lg:flex-col gap-3">
                            <button className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-2 rounded-xl transition-all group w-44">
                                <div className="p-1">
                                ...
                                <div className="text-left">
                                    <div className="text-[10px] font-medium text-stone-300 leading-none">Download on the</div>
                            ...
                            <button className="flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-2 rounded-xl transition-all group w-44">
                                ...
                                <div className="text-left">
                                    <div className="text-[10px] font-medium text-stone-300 leading-none">GET IT ON</div>
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
    return (
        <Link href={href} className="group flex items-center gap-2">
            ...
            <span className="font-urbanist text-stone-300 group-hover:text-white transition-colors">{children}</span>
        </Link>
    );
}
...
function SocialIcon({ icon: Icon, href }: { icon: any, href: string }) {
    return (
        <a href={href} className="p-2.5 bg-white/5 hover:bg-[#FFC13C] hover:text-[#270100] rounded-full transition-all duration-300 group">
            <Icon className="w-5 h-5 text-stone-300 group-hover:text-[#270100]" />
        </a>
    );
}
