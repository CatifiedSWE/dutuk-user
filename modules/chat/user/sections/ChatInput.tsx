    ...
    <div className="px-3 py-2 md:px-3 md:py-2 lg:px-4 lg:py-2.5 bg-white border-t border-gray-100 flex-shrink-0">
      <form className="relative flex items-center gap-2 md:gap-2 lg:gap-3" onSubmit={handleSubmit}>
        ...
        <div className="relative flex-grow">
          <input
            className="w-full pl-4 md:pl-4 pr-10 md:pr-10 py-2.5 md:py-2 lg:py-2.5 rounded-xl md:rounded-xl lg:rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#7C2A2A]/10 focus:border-[#7C2A2A]/30 transition-all duration-200 text-sm text-gray-900 placeholder-gray-400"
          ...
          />
          <button
            className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 active:text-gray-700 p-1.5 rounded-full hover:bg-gray-100 active:bg-gray-200 transition-colors"
            type="button"
            title="Add emoji"
          >
