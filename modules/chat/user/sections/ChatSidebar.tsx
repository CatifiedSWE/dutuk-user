...
export default function ChatSidebar({ conversations, activeConversationId, onConversationSelect }: ChatSidebarProps) {
  return (
    <aside className="w-full md:w-[340px] lg:w-[400px] flex flex-col border-r border-gray-100 bg-white z-20">
      ...
      <div className="p-6 border-b border-gray-50">
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="p-2 bg-[#FFF0F0] text-[#7C2A2A] rounded-full hover:bg-red-100 transition-colors">
      ...
      <div className="flex-grow overflow-y-auto custom-scrollbar p-4 space-y-1">
        {conversations.map((conversation) => (
          <div
            ...
            className={`p-3.5 rounded-2xl cursor-pointer relative group transition-all duration-200 ${
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="relative flex-shrink-0">
                <div className={`w-12 h-12 rounded-full bg-gray-200 overflow-hidden shadow-sm ${
                  conversation.isActive ? 'ring-2 ring-white' : 'ring-1 ring-gray-100'
                } ${
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-baseline mb-0.5">
                  ...
                  <span className={`text-[11px] font-medium ${
                    conversation.isActive ? 'text-[#7C2A2A]' : 'text-gray-400'
                  }`}>
