...
import { Heart, MapPin, Star, Crown } from 'lucide-react';
import { useState } from 'react';

// Demo premium vendor data
...
export default function PremiumEventsSection() {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#FDF5E6] to-[#F5E6D3] py-12">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
        {/* Section Header */}
        <div className="flex items-center justify-between mb-8">
          <h2 className="font-poppins font-bold text-3xl text-[#7C2A2A]">
            Premium segments
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
          {premiumVendors.map((vendor) => (
            <div
              key={vendor.id}
              className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 cursor-pointer border-2 border-[#FFC13C]/20"
            >
              {/* Image Container */}
              <div className="relative h-48 overflow-hidden">
                ...
                {/* Premium Badge */}
                <div className="absolute bottom-3 right-3 bg-[#FFC13C] text-[#7C2A2A] font-poppins font-bold text-xs px-3 py-1 rounded-full shadow-md">
                  Premium
                </div>
              ...
              <div className="p-4 pt-8">
                ...
                {/* Price Range */}
                <div className="font-poppins font-bold text-base text-[#7C2A2A]">
                  {vendor.priceRange}
                </div>
              </div>
            </div>
